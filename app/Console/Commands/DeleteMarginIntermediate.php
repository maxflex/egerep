...
class DeleteMarginIntermediate extends Command
{
    ...
    public function handle()
    {
        ...
        foreach($tutor_ids as $tutor_id) {
            ...
            $attachment_ids = DB::table('attachments as a')->join(DB::raw("(select id, attachment_id from archives where state='impossible' and (total_lessons_missing is null or total_lessons_missing=0)) as ar"), "ar.attachment_id", "=", "a.id")
