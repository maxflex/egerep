...
class Tutor extends Model
{
     ...
     */
     ...
     {
         return DB::table('accounts')->select('debt', 'debt_type')->where('tutor_id', $this->id)->orderBy('date_end', 'desc')->first();
     ...
     *
     * $type
     *  initial – первые 60 дней
     *  month   – + 1 месяц
     *  year    – + 1 год
     *  all     – всё
     */
     public function withLastAccounts($type = 'initial')
     {
