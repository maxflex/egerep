...
(function() {
  angular.module('Egerep').value('Approved', {
    ...
    4: 'статус репетитора: опубликован, к одобрению, одобрено, однако + в выезде указана хотя бы 1 станция + не указана минимальная цена выезда',
    5: 'статус репетитора опубликован + у репетитора отустствует фото'
  }).value('RequestErrors', {
