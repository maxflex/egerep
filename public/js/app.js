...
(function() {
  angular.module('Egerep').controller('AccountsCtrl', function($rootScope, $scope, $http, $timeout, Account, PaymentMethods, DebtTypes, AccountPeriods) {
    ...
    $scope.caret = 0;
    return periodsCursor(y, x, event)(function() {});
  });
...
(function() {
  angular.module('Egerep').factory('Request', function($resource) {
  ...
  }).controller('RequestsIndex', function($rootScope, $scope, $timeout, $http, Request, RequestStates, Comment, PhoneService, UserService) {
    var loadRequests;
    bindArguments($scope, arguments);
    $rootScope.frontend_loading = true;
    ...
    $scope.pageChanged = function() {
      ...
      return paginate('requests', $scope.current_page);
    };
