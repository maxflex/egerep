...
@section('content')
    <div class="row mb">
        <div class="col-sm-3">
            <div class="form-group">
                <div class="input-group custom">
                  ...
                  <input ng-highlight type="text" class="form-control digits-only" ng-model="search.id">
                </div>
            </div>
            <div class="form-group">
                <div class="input-group custom">
        ...
        <div class="col-sm-3">
            <div class="form-group">
                <ng-multi highlight object='Genders' model='search.gender' none-text='пол'></ng-multi>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <ng-multi highlight none-text='классы' model='search.grades' object='Grades'></ng-multi>
            </div>
            <div class="form-group">
                <ng-multi highlight none-text='предметы' model='search.subjects' object='Subjects.all'></ng-multi>
            </div>
        </div>
        <div class="col-sm-3">
            <div class="form-group">
        ...
        <div class="col-sm-3">
            <div class="form-group">
                <ng-multi highlight none-text='статус' model='search.state' object='TutorStates'></ng-multi>
            </div>
            <div class="form-group">
                <select ng-model='search.markers' class='sp' ng-highlight>
            ...
            <div class="form-group">
                <select ng-model='search.ready' class='sp' ng-highlight>
