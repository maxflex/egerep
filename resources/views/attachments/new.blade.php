...
<div ng-repeat='attachment in attachments' style='border-top: 1px solid #ddd; padding-top: 5px'>
    <div class="row">
        ...
        <div class="col-sm-2 vcenter" style="width: 19%; text-align: right; color: #999999">
            @{{ attachment.user_login }} @{{ formatDateTime(attachment.created_at) }}
        </div>
    </div>
    <div class="row">
        <div class="col-sm-10 vcenter" style="width: 74%">
            <div>
        ...
        <div class="col-sm-2 vcenter" style="width: 25%; text-align: right; font-size: 24px" ng-init="days_ago = daysAgo(attachment.clean_date)">
