<div ng-repeat='marker in markers'>
    <span ng-repeat='metro in marker.metros'>
        <span class="label label-metro-short" style="background: @{{ metro.station.color }}; margin-right: 3px">@{{ short(metro.station.title) }}–@{{ metro.minutes }}@{{ metro.distance > 1000 ? 'т' : 'п' }}</span>
    </span>
     –
