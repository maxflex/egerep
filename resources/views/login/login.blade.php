@extends('login')
@section('content')
<center autocomplete="off" class="animated fadeIn">
        <div style='display: none'>
            <input type="password"/>
        </div>
        <div class="input-wrapper" style='animation-duration: 1.5s'>
        ...
        <div class="input-wrapper" ng-show="sms_verification" style='position: absolute' style='animation-duration: 1.5s'>
