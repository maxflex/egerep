<div ng-show="client.attachments[selected_list_id]">
    <div class="row controls-line">
        <div class="col-sm-12">
            <span
                ng-repeat="attachment in client.attachments[selected_list_id]"
                ng-class="{'link-like': attachment.tutor_id != selected_attachment.tutor_id}"
                ng-click="selectAttachment(attachment.tutor_id)"
