<div class="row controls-line">
    <div class="col-sm-12">
        ...
        <a class='link-like show-on-hover' ng-show='selected_request' ng-click='transferRequest()'>переместить заявку в другого клиента</a>
        <a class='link-like text-danger show-on-hover' ng-show='selected_request && user.remove_requests' ng-click='removeRequest()'>удалить заявку</a>
    </div>
</div>
